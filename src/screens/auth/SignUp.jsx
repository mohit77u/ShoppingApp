    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.form}>
                {response && (
                    <Text style={response.type == 'error' ?  styles.error : styles.success}>
                        {response.message}
                    </Text>
                )}
                    
                <TextInput value={name} onChangeText={setName} style={styles.textInput} placeholder="Name" textContentType="name" />
                <TextInput value={username} onChangeText={setUsername} style={styles.textInput} placeholder="Username" textContentType="username" />
